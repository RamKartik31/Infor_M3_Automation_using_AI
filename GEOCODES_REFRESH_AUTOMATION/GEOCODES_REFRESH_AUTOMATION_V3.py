...
def common_EnterMethod(template_path,count,threshold,message):
    ...
    if  result == "1": #Means it found the template
        ...
        # next_button_int_tuple =  pyautogui.locateOnScreen('next_dev.jpg', confidence=0.9)
...
def common_CloseMethod(template_path,count,threshold,message):
    ...
    if  result == "1": #Means it found the template
        ...
        # close_button_int_tuple =  pyautogui.locateOnScreen('close_dev.jpg', confidence=0.7)
        print('close_button_int_tuple: '+str(close_button_int_tuple))
